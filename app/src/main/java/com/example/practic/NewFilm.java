...
public class NewFilm extends AppCompatActivity {
    ...
    class MyTaskTF extends AsyncTask<String, Void, Void > {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/");
                myConnection =
            ...
            try {
                myConnection.getOutputStream().write( ("comma=insertRelation&cinema_id=" + params[0]+"&film_id="+params[1]).getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            };
...
//                tvInfo.setText(str);
    ...
    class MyTaskN extends AsyncTask<String, Void, String >{
        ...
        protected String doInBackground(String... params) {
            ...
            myConnection.setDoOutput(true);
            try {
                myConnection.getOutputStream().write( ("comma=insertFilm&name=" + params[0]).getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            };
...
//            ID=result;
    ...
    class MyTask extends AsyncTask<Void, Void, ArrayList<String[]> >{
        ...
        protected ArrayList<String[]> doInBackground(Void... params) {
            ...
            HttpURLConnection myConnection = null;
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/?comma=selectAllCinema");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
